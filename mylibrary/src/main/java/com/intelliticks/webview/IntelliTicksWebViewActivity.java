package com.intelliticks.webview;
...
import com.intelliticks.webview.enums.Position;
import com.intelliticks.webview.helpers.BitmapHelper;
import com.intelliticks.webview.helpers.ColorHelper;
import com.intelliticks.webview.helpers.TypefaceHelper;
import com.intelliticks.webview.helpers.UrlParser;
import com.intelliticks.webview.listeners.BroadCastManager;
import com.intelliticks.webview.views.ShadowLayout;
 ...
 */
public class IntelliTicksWebViewActivity extends AppCompatActivity
  ...
  protected String titleDefault="intelliTicks";
  ...
  DownloadListener downloadListener = new DownloadListener() {
    ...
    public void onDownloadStart(String url, String userAgent, String contentDisposition,
      ...
      BroadCastManager.onDownloadStart(IntelliTicksWebViewActivity.this, key, url, userAgent,
  ...
  protected void initializeOptions() {
    ...
    IntelliTicksWebView.Builder builder = (IntelliTicksWebView.Builder) intent.getSerializableExtra("builder");
  ...
  protected void onDestroy() {
    super.onDestroy();
    BroadCastManager.unregister(IntelliTicksWebViewActivity.this, key);
    if (webView == null) {
      return;
    }
  ...
  public class MyWebChromeClient extends WebChromeClient {
    ...
    public void onProgressChanged(WebView view, int progress) {
      BroadCastManager.onProgressChanged(IntelliTicksWebViewActivity.this, key, progress);
    ...
    public void onReceivedTitle(WebView view, String title) {
      BroadCastManager.onReceivedTitle(IntelliTicksWebViewActivity.this, key, title);
    }

    @Override
    public void onReceivedTouchIconUrl(WebView view, String url, boolean precomposed) {
      BroadCastManager.onReceivedTouchIconUrl(IntelliTicksWebViewActivity.this, key, url, precomposed);
    }
  }
  ...
  public class MyWebViewClient extends WebViewClient {
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
      BroadCastManager.onPageStarted(IntelliTicksWebViewActivity.this, key, url);
    ...
    public void onPageFinished(WebView view, String url) {
      BroadCastManager.onPageFinished(IntelliTicksWebViewActivity.this, key, url);
    ...
    public void onLoadResource(WebView view, String url) {
      BroadCastManager.onLoadResource(IntelliTicksWebViewActivity.this, key, url);
    }

    @Override
    public void onPageCommitVisible(WebView view, String url) {
      BroadCastManager.onPageCommitVisible(IntelliTicksWebViewActivity.this, key, url);
    }
  }
}

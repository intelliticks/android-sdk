...
import com.intelliticks.webview.listeners.WebViewListener;
 ...
 */
public class IntelliTicksWebView {
  ...
  public static class Builder implements Serializable {
   ...
   // protected Boolean webViewDisplayZoomControls;
    ...
    /**
     * If you use context instead of activity, IntelliTicksWebView won't be able to override activity
     * animation.
    ...
    public Builder initilizeKey(String init_key) {
      this.initilizeKey = init_key;
      return this;
    }
    ...
    public Builder query(String query_param) {
  ...
  /*  public void load(@StringRes int dataRes) {
    ...
    protected void show(String url, String data) {
      ...
      Intent intent = new Intent(context, IntelliTicksWebViewActivity.class);
